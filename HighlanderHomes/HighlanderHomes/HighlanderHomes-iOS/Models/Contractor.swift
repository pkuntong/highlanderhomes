...
final class Contractor {
    ...
    var email: String
    var phone: String
    // Store as a single comma-separated string to avoid SwiftData transformable ambiguity
    var specialtyCSV: String = ""
    ...
    var specialty: [String] {
        ...
        set {
            specialtyCSV = newValue.joined(separator: ", ")
        }
    }
    ...
    init(
        ...
        self.email = email
        self.phone = phone
        self.specialtyCSV = specialty.joined(separator: ", ")
